        ...
        <div className="job-no">
            ...
            <div class=" jobrow ">
                ...
                <div class="d-flex justify-content-start back">
                    <div class="opsdate">
                        <label for="inputPassword" class="col-sm-4  col-form-label text-nowrap">Job Date:</label>
                        <div class="col-sm-4">
            ...
            <div class="typesofcall-row ">
                <div class="row mb-3 align-items-start">
                    <div class="col">
                        <label for="exampleFormControlInput1" class="form-label">Vessel Name<span class="required"> * </span> :</label>
                        <div class="vessel-select">
                            <select name="vessel" class="form-select vesselbox" aria-label="Default select example">
                                ...
                                <option value="671a62f13b3ccd845029310b">Jimei Shunhao</option>
                                <option value="671a63363b3ccd8450293160">MV  Toro Bianco</option>
                                <option value="671a63823b3ccd84502931bf">MV  Viva Globus</option>
                                <option value="672b44d13b3ccd84503dde97">Chicago Express</option>
                            </select>
                        </div>
                    </div>
                    <div class="col">
                        <label for="exampleFormControlInput1" class="form-label">Port Name<span class="required"> * </span> :</label>
                        <div class="vessel-select">
                            <select name="port" class="form-select vesselbox" aria-label="Default select example">
                                <option value="">Choose Port name</option>
                                <option value="673dda5e3b3ccd84505ab453">Port Fujairah</option>
                                <option value="673dda283b3ccd84505ab415">Port Mina Al Fahl</option>
                                ...
                                <option value="671a5f883b3ccd8450292c7c">Port of Khasab</option>
                                <option value="671a5f6c3b3ccd8450292c58">Port of Muscat</option>
                                <option value="671a5f793b3ccd8450292c66">Port of Salalah</option>
                                <option value="671a5f943b3ccd8450292c90">Port of Shinas</option>
                                <option value="671a5fb53b3ccd8450292cb8">Port of Sohar</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="typesofcall-row ">
                <div class="row  mb-3 align-items-start">
                    <div class="col ">
                        <label for="exampleFormControlInput1" class="form-label"> Cargo <span class="required"> * </span> :</label>
                        <div class="vessel-select">
                            <select name="vessel" class="form-select vesselbox" aria-label="Default select example">
                                <option value="">Choose Cargo</option>
                                <option value="671a62f13b3ccd845029310b"> Anthracite Coal</option>
                                <option value="671a63363b3ccd8450293160">Bundled Steel</option>
            ...
            <div class="typesofcall-row ">
                <div class="row align-items-start">
                    <div class="mb-2">
                        <label for="formFile" class="form-label">Documents Upload:</label>
                        <input class="form-control documentsfsize" type="file" id="formFile"></input>
                    </div>
                </div>
            </div>
 {/* sixthrowremarks */}
                ...
                <div class="col">
                    <div class="mb-3">
                        <div class="col">
                            ...
                            <textarea rows="1" class="form-control" id="exampleFormControlInput1" placeholder="" name="remarks"></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="buttons-wrapper">
    <div class="left">
        <button class="btn btna submit-button btnfsize">Generate PDF</button>
        </div>
        <div class="right">
            <button class="btn btna submit-button btnfsize">Final Report</button>
