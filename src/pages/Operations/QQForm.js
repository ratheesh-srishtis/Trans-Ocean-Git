  ...
  return (
    <>
      <div className="">
       ...
       <div className="p-4">
        ...
        <div className="mt-4">
          <table className="tab">
            <thead>
              <tr>
                <td className="styltabl">
                  01.</td>
                <td
                  className="tabsplstyl">
       ...
       <div className="grade">
        * Grades 01 Excellent Service 02 Good 03 Satisfactory 04 Average 05 Need Improvements N/A Not Applicable
       </div>
       
        <div class="greport">
          <button class="btn btna submit-button btnfsize mb-4">
            Generate Report
          </button>
        </div>
      </div>
